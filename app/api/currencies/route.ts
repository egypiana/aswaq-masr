...
// ── Egyptian banks with typical spread factors ───────────────
const BANKS = [
  { nameAr: 'البنك الأهلي المصري',        shortName: 'NBE',  spread: 0.10, seed: 1 },
  { nameAr: 'بنك مصر',                    shortName: 'BM',   spread: 0.12, seed: 2 },
  { nameAr: 'البنك التجاري الدولي',       shortName: 'CIB',  spread: 0.14, seed: 3 },
  { nameAr: 'بنك القاهرة',               shortName: 'BOC',  spread: 0.13, seed: 4 },
  { nameAr: 'HSBC مصر',                  shortName: 'HSBC', spread: 0.16, seed: 5 },
  { nameAr: 'البنك الأهلي الكويتي',       shortName: 'ABK',  spread: 0.15, seed: 6 },
  { nameAr: 'بنك قناة السويس',           shortName: 'SCB',  spread: 0.14, seed: 7 },
  { nameAr: 'بنك نكست',                  shortName: 'NXT',  spread: 0.13, seed: 8 },
  { nameAr: 'بنك الشركة المصرفية',        shortName: 'SAIB', spread: 0.15, seed: 9 },
  { nameAr: 'بنك أبوظبي الإسلامي',       shortName: 'ADIB', spread: 0.16, seed: 10 },
];
